    ...
    <section className='px-4 md:px-32 py-12 z-10 relative'>
        ...
        <div className='flex flex-col md:flex-row gap-8 items-center'>
            <div className='space-y-4 md:w-2/3'>
                <h2 className='font-medium font-poppins text-2xl uppercase text-[#eee]'>!! Upcoming event !!</h2>
                ...
                <a href="/hack" className='text-lg inline-block relative overflow-hidden bg-gradient-to-b from-primary to-secondary group transition p-2 px-5 rounded-full font-bold font-mont'>
